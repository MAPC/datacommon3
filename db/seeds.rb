...
institutions.each {|record| Institution.create_or_update record, without_protection: true }
brandings.each    {|record| Branding.create_or_update    record, without_protection: true }
pages.each        {|record| Page.create_or_update        record, without_protection: true }
